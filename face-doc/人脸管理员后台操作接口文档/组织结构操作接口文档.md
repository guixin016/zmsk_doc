...
|URL|face.doinggo.com/api/admin/organization/create?pid=&name=&description=|
|---|---|
|method|POST|
...
|URL|face.doinggo.com/api/admin/organization/update?organizationId=&pid=&name=&description=|
|---|---|
|method|POST|
